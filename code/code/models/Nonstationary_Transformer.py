...
class Model(nn.Module):
    ...
    def imputation(self, x_enc, x_mark_enc, x_dec, x_mark_dec, mask,block_mask):
    ...
    def forward(self, x_enc, x_mark_enc, x_dec, x_mark_dec, mask=None,block_mask=None):
        if self.task_name == 'imputation' or self.task_name=="imputation_graph":
            dec_out = self.imputation(x_enc, x_mark_enc, x_dec, x_mark_dec, mask,block_mask)
