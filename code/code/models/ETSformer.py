...
class Model(nn.Module):
    ...
    def __init__(self, configs):
        ...
        if self.task_name == 'classification' or self.task_name == 'anomaly_detection' or self.task_name == 'imputation' or self.task_name=="imputation graph":
    ...
    def forward(self, x_enc, x_mark_enc, x_dec, x_mark_dec, mask=None):
        ...
        if self.task_name == 'imputation' or self.task_name=="imputation graph":
